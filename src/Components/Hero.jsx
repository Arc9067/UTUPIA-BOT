...
const Hero = () => {
  return (
    <section className="pt-32 pb-28 md:pb-52 w-full relative">
      <img
        src={heroSpahe}
        alt=""
        className="absolute bottom-0 w-full pointer-events-none"
      />
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 justify-between items-center">
        <article className="flex flex-col gap-6">
          <h1 className="text-5xl font-bold leading-[120%] md:leading-[76px] md:text-7xl ">
            Introducing The Community Powered Sniper Bot{" "}
            <span className="text-[#FF8226]">UTOPIA</span>
          </h1>
          <p className=" font-normal leading-loose tracking-tight">
            Utopia is the first sniper where you decide what we should implement
            next!
          </p>
        ...
        <img src={logo} alt="logo" className="mx-auto lg:ml-auto" />
      </div>
    </section>
  );
};
